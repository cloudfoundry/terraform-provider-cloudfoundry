...
page_title: "cloudfoundry_org List Resource - Cloud Foundry"
subcategory: ""
description: |-
  This list resource allows you to discover all organizations the user has access to.
---

# cloudfoundry_org (List Resource)
