...
page_title: "cloudfoundry_service_route_binding List Resource - Cloud Foundry"
subcategory: ""
description: |-
  This list resource allows you to discover all service route bindings the caller has access to, optionally filtered by service instance or route.
---

# cloudfoundry_service_route_binding (List Resource)
...
- `route` (String) The GUID of the route to filter route bindings by.
- `service_instance` (String) The GUID of the service instance to filter route bindings by.
