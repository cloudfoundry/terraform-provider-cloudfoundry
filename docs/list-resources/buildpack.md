...
page_title: "cloudfoundry_buildpack List Resource - Cloud Foundry"
subcategory: ""
description: |-
  This list resource allows you to discover all buildpacks the user has access to, optionally filtered by name or stack.
---

# cloudfoundry_buildpack (List Resource)
...
- `stack` (String) The name of the stack to filter buildpacks by.
