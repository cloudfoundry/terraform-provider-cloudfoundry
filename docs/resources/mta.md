...
- `skip_idle_start` (Boolean) Directly start the new MTA version as 'live', skipping the 'idle' phase of the resources. This value defaults to true when not explicitly specified.
